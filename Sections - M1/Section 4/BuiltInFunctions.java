public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
        ...
        boolean firstLetter = programming.startsWith("a", 3);
        ...
        String updatedString = original.replace('J', 'Y');
        ...
        double base = 2;
        double exponent = 3;
        double final1 = Math.pow(base, exponent);
